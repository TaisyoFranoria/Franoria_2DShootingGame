...
void UI_gamescene::update(player* pl) {
	...
	DrawFormatString(880,80,0xFFFFFF,"LIFE:");
	DrawFormatString(880,100,0xFFFFFF,"POW :");
	DrawExtendGraph(930,80,930+100*(pl->get_status(0)/pl_lifeMAX),98,gra[2],TRUE);
	DrawExtendGraph(930,100,930+100*(pl->get_status(2)/pl_powMAX),118,gra[1],TRUE);
